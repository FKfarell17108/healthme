...
def main():
    ...
    st.write('Masukkan informasi nutrisi makanan untuk memprediksi kandungan kalori.')
    ...
    # Memilih makanan dari dropdown
    makanan_list = data['Makanan'].tolist()
    makanan = st.selectbox('Pilih Makanan', makanan_list)

    # Menampilkan informasi nutrisi makanan yang dipilih
